...
using Hansom.Tests.Application.Sagas;
using Hansom.Tests.Domain;

namespace Hansom.Tests.Application.Tracking;
...
public sealed class TrackedSessionTests
{
    ...
    public async Task untracked_invoke_still_does_not_run_cascaded_handlers()
    {
        ...
        IMessageBus bus = new Hansom.Application.Mediator.Mediator(catalog, cascades);
    ...
    public async Task descendant_handler_fault_stops_siblings_and_sets_session()
    {
        ...
        IMessageBus bus = new Hansom.Application.Mediator.Mediator(catalog);
    ...
    public async Task tracked_root_handler_fault_sets_session_with_attempts()
    {
        ...
        IMessageBus bus = new Hansom.Application.Mediator.Mediator(catalog, policies: policies);
    ...
    private static IMessageBus ConversationBus()
    {
        ...
        return new Hansom.Application.Mediator.Mediator(catalog, policies: policies);
    }
