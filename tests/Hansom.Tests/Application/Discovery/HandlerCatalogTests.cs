...
using Hansom.Tests.Application.Discovery.InvalidSignatures;
using Hansom.Tests.Application.Discovery.Other;
using Hansom.Tests.Application.Discovery.Scanned;
...
public sealed class HandlerCatalogTests
{
    ...
    {
        var catalog = new HandlerCatalog();
        catalog.IncludeNamespace("Hansom.Tests.Application.Discovery.Scanned");
    ...
    {
        var catalog = new HandlerCatalog();
        catalog.ExcludeNamespace("Hansom.Tests.Application.Discovery.Other");
        catalog.ExcludeNamespace("Hansom.Tests.Application.Discovery.InvalidSignatures");
    ...
    public void missing_handler_is_a_port_not_an_invoker()
    {
        ...
        Assert.Equal(typeof(Hansom.Domain.Envelope.Envelope), method.GetParameters()[0].ParameterType);
