...
namespace Hansom.Application.Transports;
...
/// writes bytes on a socket; Hansom.RabbitMQ is its ITransport; Hansom.Http is
...
public interface ITransport
{
    ...
    /// Routing uses the scheme on <see cref="Hansom.Domain.Envelope.ValueObjects.Destination"/>
